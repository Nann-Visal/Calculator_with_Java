...
public class Number_Convertor extends JPanel {
    ...
    private JButton jButton0 = new JButton("A");
    ...
    private JButton jButton5 = new JButton("B");
    ...
    private JButton jButton11 = new JButton("BINARY");
    private JButton jButton12 = new JButton("0");
    private JButton jButton13 = new JButton("C");
    private JButton jButton14 = new JButton("D");
    private JButton jButton15 = new JButton("E");
    private JButton jButton16 = new JButton("F");
    private JButton jButton17 = new JButton("OCTAL");
    private JButton jButton18 = new JButton("HEXA");
    private JButton jButton19 = new JButton("CONVERT");
    private JButton jButton23 = new JButton("DECIMAL");
    ...
    private void createSubPanel2_2(){
        ...
        gbc.gridy=1;
        gbc.insets = new Insets(10,10,10,10);
        subPanel2_2.add(jButton0,gbc);

        gbc.fill=GridBagConstraints.HORIZONTAL;
        gbc.gridx=0;
        gbc.gridy=2;
        gbc.insets = new Insets(10,10,10,10);
        subPanel2_2.add(jButton5,gbc);

        gbc.fill=GridBagConstraints.HORIZONTAL;
        gbc.gridx=0;
        gbc.gridy=3;
        gbc.insets = new Insets(10,10,10,10);
        subPanel2_2.add(jButton13,gbc);
        ...
        gbc.gridy=1;
        gbc.insets = new Insets(10,10,10,10);
        subPanel2_2.add(jButton14,gbc);

        gbc.fill=GridBagConstraints.HORIZONTAL;
        gbc.gridx=4;
        gbc.gridy=2;
        gbc.insets = new Insets(10,10,10,10);
        subPanel2_2.add(jButton15,gbc);
    ...
    private void createButton(){
        ...
        jButton0.setBorder(border);
        jButton0.setBackground(Color.white);
        jButton0.setOpaque(true);
        jButton0.setPreferredSize(new Dimension(200,50));
        jButton0.setFont(new Font("arial", Font.BOLD,30));
        ...
        jButton13.setPreferredSize(new Dimension(200,50));
        jButton13.setFont(new Font("arial", Font.BOLD,30));
        ...
        jButton14.setPreferredSize(new Dimension(200,50));
        jButton14.setFont(new Font("arial", Font.BOLD,30));
        ...
        jButton15.setPreferredSize(new Dimension(200,50));
        jButton15.setFont(new Font("arial", Font.BOLD,30));
    ...
    public Number_Convertor(String label){
        title = new JLabel(label,JLabel.CENTER);
