...
public class Money_ExchangePanel extends JPanel {
    ...
    private JLabel title = new JLabel("MONEY CHANGE",JLabel.CENTER);
    ...
    private JButton jButton17 = new JButton("CHANGE");
    private JButton jButton18 = new JButton("EURO");
    private JButton jButton19 = new JButton("FRANCE");
    private JButton jButton20 = new JButton("RIEL");
    private JButton jButton21 = new JButton("BART");
    private JButton jButton22 = new JButton("DOLA");
    ...
    private void createSubPanel2_2(){
        ...
        gbc.gridy=2;
        gbc.insets = new Insets(10,10,10,10);
        subPanel2_2.add(jButton20,gbc);

        gbc.fill=GridBagConstraints.HORIZONTAL;
        gbc.gridx=0;
        gbc.gridy=3;
        gbc.insets = new Insets(10,10,10,10);
        subPanel2_2.add(jButton21,gbc);
    ...
    private void createButton(){
        ...
        jButton20.setPreferredSize(new Dimension(200,50));
        jButton20.setFont(new Font("arial", Font.BOLD,30));
        ...
        jButton21.setPreferredSize(new Dimension(200,50));
        jButton21.setFont(new Font("arial", Font.BOLD,30));
