...
public class TrigonometryPanel extends JPanel {
    ...
    private JLabel title = new JLabel("TRIGONOMETRY",JLabel.CENTER);
    ...
    private JButton jButton18 = new JButton("DEGREE");
    private JButton jButton19 = new JButton("<~~");
    private JButton jButton20 = new JButton("SIN");
    private JButton jButton21 = new JButton("COS");
    private JButton jButton22 = new JButton("TAN");
    private JButton jButton23 = new JButton("RAND");
